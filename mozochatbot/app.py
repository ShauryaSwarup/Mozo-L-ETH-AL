...
st.set_page_config(page_title='Llama2 based DOS DAO Chatbot')
st.header('Custom Llama2-Powered Open Science DAO Chatbot :robot_face:')
...
def get_user_input():
    ...
    # get the user query
    input_text = st.text_input('Ask me anything about the proposal of your choice!', "", key='input')
    return input_text
